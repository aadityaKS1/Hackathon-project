   ...
   const navigate = useNavigate();
    ...
    return (
        <div className="absolute top-[581px] left-1/2 transform -translate-x-1/2 w-[512px] h-[801px] bg-[#F8F9FAFF] rounded-[14px] shadow-[0_25px_50px_rgba(0,0,0,0.25)]">
            ...
            <button
  className="absolute top-[62px] left-[25px] w-[239px] h-[36px] px-[12px]
             flex items-center justify-center
             font-inter text-[14px] leading-[22px] font-normal text-white
             bg-[#4A90E2FF] rounded-[16px]
             hover:bg-[#3181DDFF] active:bg-[#2272CEFF] disabled:opacity-40" onClick={handleRegister_volunteer}
>
  Volunteer
</button>

         <button
  className="absolute top-[62px] left-[308px] w-[140px] h-[36px] px-[12px]
             flex items-center justify-center
             font-inter text-[14px] leading-[22px] font-normal text-[#323743FF]
             bg-[#DEE1E6FF] rounded-[16px]
             hover:bg-[#DEE1E6FF] hover:text-[#323743FF]
             active:bg-[#DEE1E6FF] active:text-[#323743FF]
             disabled:opacity-40" onClick={handleRegister_club}
>
  Organization
</button>
            ...
            <div className="absolute top-[511px] left-[47px] w-[416px]">
            ...
            {/* Submit Button */}
<div className="absolute top-[579px] left-[47px] w-[416px]">
  <button
...
{/* Secondary Button */}
<div className="absolute top-[645px] left-[171px] w-[180px]">
  <button
    className="w-full h-[40px] px-[12px] flex items-center justify-center
...
<div className="flex gap-2">
    ...
    <p className="absolute top-[695px] left-[144px] font-inter text-[14px] leading-[20px] font-normal text-[#565D6DFF]">
  Already have an account? 
</p>
<button
  className="absolute top-[695px] left-[317px] w-[76px] h-[22px] px-[12px] 
             font-inter text-[14px] leading-[22px] font-medium text-[#4A90E2FF] bg-transparent
             rounded-[10px] hover:text-[#4A90E2FF] active:text-[#4A90E2FF] disabled:opacity-40" onClick={handleSignUp}
>
  Sign In
</button>
